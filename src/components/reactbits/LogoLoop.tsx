...
function useResizeObserver(callback: () => void, elements: React.RefObject<HTMLElement>[], dependencies: any[]) {
  useEffect(() => {
...
function useImageLoader(seqRef: React.RefObject<HTMLElement>, onLoad: () => void, dependencies: any[]) {
  useEffect(() => {
