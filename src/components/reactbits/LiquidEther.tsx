...
`
    ...
    const io = new IntersectionObserver(
      (entries) => {
        ...
        if (!webglRef.current) return
        // The very first callback can fire before layout has settled (e.g. mid
        // CSS transition on an ancestor), sometimes misreporting zero intersection.
        // We already explicitly started rendering above, so only let this
        // observer *pause* things once we've seen a real, later state change.
